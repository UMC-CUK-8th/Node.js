...
- 미션 기록
    ...
    ***Data Grip을 이용하여 테이블 생성하기***
    ...
    <img width="397" alt="schema 확인" src="https://github.com/user-attachments/assets/4a2c3f3e-b8a3-4cf6-8c74-6ef00a13b298" />

    
    1. SQL 문을 활용해 테이블 작성 - 이 때, 앞서 작성했던 ERD를 활용했다.
    
  <img width="1116" alt="ERD" src="https://github.com/user-attachments/assets/894f2391-6764-44f1-bb87-d6ca5ab96a88" />

    
    > 활용한 ERD
    > 
    
    <img width="802" alt="SQl 테이블 작성문" src="https://github.com/user-attachments/assets/0c1d6b79-b0a9-47bc-82c5-5b354d1b6ae3" />
    ...
    <img width="402" alt="테이블 완성" src="https://github.com/user-attachments/assets/73ae5a98-e548-491b-952b-cd40a5ac9e9e" />

    
    > 총 13개의 테이블을 생성한 모습
    > 
    
    <img width="973" alt="datagrip ERD" src="https://github.com/user-attachments/assets/bc255b08-9f86-452e-b160-be90b9380ac8" />
    ...
    <img width="805" alt="workbench test" src="https://github.com/user-attachments/assets/674ea59f-1504-4381-bffb-5f6e16e436e0" />
